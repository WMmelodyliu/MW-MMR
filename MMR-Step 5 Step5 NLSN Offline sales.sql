## Step 5 is split and done Separately for NLSN and NPD (offline and online) : 4 queries 
--mmr2_temp_scan_fy25Feb_nlsn_restatement_hist_janupc is built using jan upc file

CREATE OR REPLACE TABLE `wmt-mint-mmr-mw-prod.MMR_numerator.mmr2_temp_scan_FY26Mar_NLSN` -- UPDATE #restatement
...
-- lkp_nielsen_upc_mapping_fy25Feb_new
	...
	join `wmt-mint-mmr-mw-prod.MMR_numerator.lkp_mmr_hier_id_restatement_FY26Feb_NLSN` t2 -- UPDATE #restatement
