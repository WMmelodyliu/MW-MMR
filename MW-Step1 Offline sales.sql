CREATE OR REPLACE TABLE wmt-mint-mmr-mw-prod.mw_numerator_dev.offline_sales_FY26Mar_breakout AS --update(R)
...
where 
event_dt between '2024-11-23' and '2025-04-04' --update(R)
